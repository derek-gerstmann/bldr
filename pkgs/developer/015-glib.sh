...
pkg_cflags="$pkg_cflags:-I$BLDR_LOCAL_PATH/system/libffi/latest/include"
pkg_cflags="$pkg_cflags:-I$BLDR_LOCAL_PATH/system/gettext/latest/include"
pkg_cflags="$pkg_cflags:-I$BLDR_LOCAL_PATH/system/gettext/latest/share/gettext"

pkg_ldflags="-L$BLDR_LOCAL_PATH/system/zlib/latest/lib:-lz"
pkg_ldflags="$pkg_ldflags:-L$BLDR_LOCAL_PATH/system/libffi/latest/lib:-lffi"
...
pkg_ldflags="$pkg_ldflags:-L$BLDR_LOCAL_PATH/system/libiconv/latest/lib:-liconv"
pkg_ldflags="$pkg_ldflags:-L$BLDR_LOCAL_PATH/system/gettext/latest/lib:-lasprintf:-lgettextpo"
