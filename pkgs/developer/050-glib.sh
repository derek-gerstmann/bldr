...
pkg_cflags="$pkg_cflags:-I$BLDR_LOCAL_PATH/developer/gettext/latest/include"
pkg_cflags="$pkg_cflags:-I$BLDR_LOCAL_PATH/developer/gettext/latest/share/gettext"
...
pkg_ldflags="$pkg_ldflags:-L$BLDR_LOCAL_PATH/developer/gettext/latest/lib:-lasprintf:-lgettextpo"
