...
pkg_cflags="$pkg_cflags:-I$BLDR_LOCAL_DIR/imaging/lcms2/latest/include"
pkg_cflags="$pkg_cflags:-I$BLDR_LOCAL_DIR/imaging/libpng/latest/include"
pkg_cflags="$pkg_cflags:-I$BLDR_LOCAL_DIR/imaging/libtiff/latest/include"

pkg_ldflags="-L$BLDR_LOCAL_DIR/system/zlib/latest/lib"
pkg_ldflags="$pkg_ldflags:-L$BLDR_LOCAL_DIR/imaging/lcms2/latest/lib"
pkg_ldflags="$pkg_ldflags:-L$BLDR_LOCAL_DIR/imaging/libpng/latest/lib"
pkg_ldflags="$pkg_ldflags:-L$BLDR_LOCAL_DIR/imaging/libtiff/latest/lib"

pkg_cfg="--disable-dependency-tracking --enable-tiff --enable-mj2 --enable-jpwl --enable-jpip --enable-jpip-server "
pkg_cfg="$pkg_cfg Z_CFLAGS=-I$BLDR_LOCAL_DIR/system/zlib/latest/include"
pkg_cfg="$pkg_cfg Z_LIBS=-lz"
pkg_cfg="$pkg_cfg PNG_CFLAGS=-I$BLDR_LOCAL_DIR/imaging/libpng/latest/include"
pkg_cfg="$pkg_cfg PNG_LIBS=-lpng"
pkg_cfg="$pkg_cfg TIFF_CFLAGS=-I$BLDR_LOCAL_DIR/imaging/libtiff/latest/include"
