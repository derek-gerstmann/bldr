...
pkg_cfg=""
pkg_cfg="$pkg_cfg --with-xz=$BLDR_LOCAL_PATH/compression/xz/default/bin/xz"
pkg_cfg="$pkg_cfg --with-lzip=$BLDR_LOCAL_PATH/compression/zlib/default/lib/libz.a"
pkg_cfg="$pkg_cfg --with-gzip=$BLDR_LOCAL_PATH/compression/gzip/default/bin/gzip"
pkg_cfg="$pkg_cfg --with-bzip2=$BLDR_LOCAL_PATH/compression/bzip2/default/bin/bzip2"
